      ...
      },
      {
        ...
        submenu: [
          ...
          },
          {
            ...
            click: () => {
              openExternal(
                'https://github.com/petroleum-network/petroleum-blockchain/releases',
              );
            },
          },
          {
            ...
            click: () => {
              openExternal(
                'https://github.com/petroleum-network/petroleum-blockchain/blob/main/CONTRIBUTING.md',
              );
            },
          },
          {
          ...
          {
            label: i18n._(/* i18n */ { id: 'Chia Fork Space' }),
            click: () => {
              openExternal(
                'https://chiafork.space',
              );
            },
          },
          {
          ...
          {
            label: i18n._(/* i18n */ { id: 'Petroleum Twitter' }),
            click: () => {
              openExternal(
                'https://www.twitter.com/forkpetroleum',
              );
            },
          },
          {
            label: i18n._(/* i18n */ { id: 'Petroleum Website' }),
            click: () => {
              openExternal(
                'https://petroleum.farm/',
              );
            },
          },
          {
          ...
          },
          {
            ...
            click: () => {
              openExternal(
                'https://github.com/petroleum-network/petroleum-blockchain/issues',
              );
            },
          },
        ],
